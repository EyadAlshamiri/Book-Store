...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 8b709aeb-77ac-4524-ace0-672caade2017
```

> `8b709aeb-77ac-4524-ace0-672caade2017` is the password of the certificate, you can change it to any password you want.
